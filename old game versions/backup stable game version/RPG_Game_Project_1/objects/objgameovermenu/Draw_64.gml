...
{	
	...
	draw_text(menu_x+total_width/2, (menu_y*4) + font_get_size(FontGenericMenu), "GAME OVER");
	menu_y += font_get_size(FontGenericMenu);
	
	
	// draw all the options
	for (var i = 1 ; i < nr_options_pm-1 ; i++)
	{
		// draw options
	...
	draw_text(menu_x+total_width/2, menu_y + total_height*0.7 + font_get_size(FontGenericMenu), text);
}
